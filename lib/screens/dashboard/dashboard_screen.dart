...
class DashboardScreen extends StatefulWidget {
  ...
  DashboardScreen({this.redirectToBooking, this.id});
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    print("this is the language ${appStore.selectedLanguageCode}");

    // initializeing dynamic link by initDynamicLinks();
    initDynamicLinks();
  ...
  /// handling dynamic link, --- Addiitonal feature
  ...
  Future<void> initDynamicLinks() async {
    dynamicLinks.onLink.listen((dynamicLinkData) {
      ...
      if (queryParams.isNotEmpty) {
        ...
        if (dynamicLinkData.link.path == "/providerDetails") {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) =>
                      ProviderInfoScreen(providerId: productId.toInt())));
        } else if (dynamicLinkData.link.path == "/serviceDetails") {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) =>
                      ServiceDetailScreen(serviceId: productId.toInt())));
        } else {
          // Navigator.pushNamed(
          //   context,
