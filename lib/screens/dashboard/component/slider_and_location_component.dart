...
class _SliderLocationComponentState extends State<SliderLocationComponent> {
  ...
  Widget imagelocate(code) {
    if (code == "en") {
      return Image.asset(
        "assets/flag/ic_us.png",
        width: 30,
        height: 50,
      );
    } else if (code == "ar") {
      return Image.asset("assets/flag/ic_ar.png", width: 24);
    } else if (code == "fr") {
      return Image.asset("assets/flag/ic_fr.png", width: 24);
    } else if (code == "hi") {
      return Image.asset("assets/flag/ic_india.png", width: 24);
    } else if (code == "de") {
      return Image.asset("assets/flag/ic_de.png", width: 24);
    }
    return Container();
  }
              ...
              Row(
                children: [
                  ...
                  Container(
                      ...
                      child: Row(
                        children: [
                          imagelocate(appStore.selectedLanguageCode),
                          4.width,
                          Text(
